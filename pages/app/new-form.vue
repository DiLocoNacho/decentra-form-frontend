        ...
        >
          <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
            ...
            >
              ...
              <div class="relative ml-4 mt-4 flex-shrink-0">
                <button
                  type="button"
      ...
      <div class="flex-1 relative z-0 flex overflow-hidden">
        ...
        >
          ...
          <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
            ...
            >
              <div class="ml-4 mt-4">
                <h3 class="text-lg my-1.5 leading-6 font-medium text-gray-900">
                  Settings
                </h3>
              </div>
            </div>
...
export default {
  ...
  methods: {
    updateValue(value) {
      this.$set(this.steps[this.indexCurrentStep], value.field, value.value)
    },
    addStep(step) {
